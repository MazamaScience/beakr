  ...
  R6::R6Class(
    ...
    public = list(
      req = list(
        ...
        rook_url_scheme = "http",
        rook_input = list(readLines = function() return("") ),
    ...
    body=function(body){
      self$req$rook_input$read_lines=function() return(body)
    },
...
#'
#' @export
process_test_request<-function(beakr, test_request){
